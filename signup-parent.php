    ...
    if (empty($full_name) || empty($email) || empty($password) || empty($confirm_password)) {
        ...
        if ($check_stmt->get_result()->num_rows > 0) {
            ...
            if ($user_stmt->execute()) {
                $success = "Registration successful! You can now <a href='login.php' style='color: #155724; font-weight: 600;'>login</a> as a parent. You can link your child's account later from your dashboard.";
                $_POST = [];
            } else {
...
<body>
    <div class="signup-container">
        <div class="app-title">👨‍👩‍👧 Parent Registration</div>
        <div class="app-subtitle">Create your parent account</div>

        <div class="info-box">
            ℹ️ After registration, you can link your child's account from your dashboard to monitor their progress.
        </div>
